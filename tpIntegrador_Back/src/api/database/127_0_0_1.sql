...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2026 a las 01:54:27
...
INSERT INTO `alumnos` (`legajo`, `nombre`, `apellido`, `fecha_nacimiento`, `email`) VALUES
(1236, 'Luciano ', 'Juárez', '2000-05-25', 'lucianopistola@gmail.com');
...
INSERT INTO `notas` (`id_nota`, `id_alumno`, `id_materia`, `nota`, `fecha`) VALUES
(1, 1236, 1, 4, '2026-05-15'),
(2, 1236, 2, 10, '2026-05-07'),
(3, 1236, 3, 7, '2026-05-08');
...
ALTER TABLE `notas`
  ...
  ADD KEY `notas_fk_materia` (`id_materia`);
...
--
ALTER TABLE `notas`
  ADD CONSTRAINT `notas_fk_materia` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`id_materia`) ON DELETE CASCADE,
  ADD CONSTRAINT `notas_ibfk_1` FOREIGN KEY (`id_alumno`) REFERENCES `alumnos` (`legajo`) ON DELETE CASCADE;
--
-- Base de datos: `basetp`
--
CREATE DATABASE IF NOT EXISTS `basetp` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `basetp`;
...
('root', '[{\"db\":\"basetp\",\"table\":\"products\"},{\"db\":\"alumnos\",\"table\":\"alumnos\"},{\"db\":\"alumnos\",\"table\":\"notas\"},{\"db\":\"alumnos\",\"table\":\"materias\"}]');
...
('root', '2026-06-24 23:54:22', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
